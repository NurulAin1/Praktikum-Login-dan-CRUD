...
<div class="row clearfix">
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 " style="padding:100px; margin-left:225px; margin-top:-100px; background-color:white;font-size: 20px; text-align:center; width:1200px;height:650px;">
    <div class="card">
      <div class="header">
        <?php
